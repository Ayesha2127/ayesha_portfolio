...
        >
                ...
                <p className="text-lg md:text-xl  lg:text-2xl flex-col w-full max-w-[700px] pt-4 text-center flex-wrap sm:max-w-[500px] md:px-5">
                 A passionate web developer and designer from Pakistan. With a keen eye for detail and
                 a commitment to creating visually appealing, user-friendly websites, I bring together
                 creativity and technical expertise to deliver high-quality digital solutions.
                </p>
          </div>
            </div>
